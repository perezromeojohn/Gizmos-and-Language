...
namespace Michsky.LSS
{
    ...
    public class LoadingScreenManagerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            var fadeOutMultiplier = serializedObject.FindProperty("fadeOutMultiplier");
            ...
            else
            {
                if (lsList.Count == 1 || lsList.Count >= 1)
                {
                    ...
                    {
                        LSSEditorHandler.DrawProperty(sceneName, customSkin, "Load Scene");
                    }
                    ...
                    LSSEditorHandler.DrawPropertyCW(fadeOutMultiplier, customSkin, "Audio Fade Multiplier", 134);
